...
const Certificates= () => {
  ...
  return (
    <div>
        {is1292 ? (
        <div className='min-h-[50rem] justify-around select-none mx-auto items-center flex flex-col '>
        ...
        <div className='min-h-[50rem] w-full select-none justify-around  items-center flex flex-col'>
